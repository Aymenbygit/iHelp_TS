...
import { getReports } from "../../../../redux/action/reportAction";
            ...
            <div className="productBottom">
              <form className="productForm">
                <div className="productFormLeft">
                  ...
                  <label>
                    ...
                    {PostList.map((el) => el._id).includes(el.target) ? (
                      <Link to={`/admin/product/${el.target}`}>Check Post</Link>
                    ) : (
                ...
                <div className="productFormRight">
                  <Link to={`/admin/ReportList/${el._id}`}>
                    <button className="productButton">Display</button>
                  </Link>
                </div>
              </form>
            </div>
